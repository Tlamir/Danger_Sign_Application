Shader "LiquidVolume/Bump" {
	Properties {
		...
		[HideInInspector] _BumpStrength ("Normal Strength", Range(0,1)) = 1
	...
	// PBS Liquid ====================================================================================================================================
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			p = lerp(p, _FlaskColor, _FlaskColor.a);
			o.Alpha = p.a * _FlaskTexAlpha;
			o.Albedo = p.rgb;
			o.Normal = lerp(float3(0.5, 0.5, 1), UnpackNormal (tex2D (_BumpMap, IN.uv_BumpMap)), _BumpStrength);
			o.Metallic = 0;
