...
namespace Obi
{
    ...
    public class ObiEmitter : ObiActor
    {
        ...
        /// <summary>  
        /// Phase value used by particles emitted from this emitter.
        /// </summary>
        ...
        private void UpdateParticleMaterial(int index)
        {
            ...
            m_Solver.phases[solverIndex] = ObiUtils.MakePhase(fluidPhase, Oni.ParticleFlags.SelfCollide | particlePhase);
        }
